...
urlpatterns = [
    ...
    path('request/moderator/permissions', views.request_mod, name='moderator_request'),
    ...
    path('profile/followers/', views.FollowerPage.as_view(), name='followers'),
    path('profile/search/', views.SearchProfile.as_view(), name='profile_search'),
    path('profile/search/result', views.search_profile_result, name='profile_search_result'),
